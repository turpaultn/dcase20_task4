...
if __name__ == '__main__':
    ...
    parser.add_argument("-sm", '--switch_mode', type=str, dest="switch_mode",
                        help="mean teacher mode or PLG-MT mode.")
    ...
    switch_mode = f_args.switch_mode

    store_dir = os.path.join("stored_data", "MeanTeacher")
