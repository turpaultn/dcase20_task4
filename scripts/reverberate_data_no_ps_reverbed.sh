...
SUBSET=validation  # Here the subset is also used to define the subset of RIR to use
INPUT_PATH=../dataset/audio/${SUBSET}/synthetic20_${SUBSET}_no_ps
...
NPROC=1 # Be careful, if you do not use the same number of processors, you won't reproduce the baseline data.
