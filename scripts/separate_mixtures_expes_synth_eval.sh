...
do
	...
	subset=eval
	audio_synth=${BASE_DATASET}/audio/eval_sources/synthetic20_${subset}/soundscapes
	sources_synth=${BASE_DATASET}/audio/eval_sources/synthetic20_${subset}/separated_sources_${model_name}
